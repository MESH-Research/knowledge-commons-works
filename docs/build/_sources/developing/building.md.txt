...
<img src="../_static/static_build_process_collect.jpg" alt="webpack collect" width="500"/>
...
This creates a symlink from the `assets` directory to the `/opt/invenio/var/instance/assets` directory.
