...
PYTHON_LOCAL_GIT_PACKAGES_PATH=/local/path/to/cloned/repository/knowledge-commons-works/site/kcworks/dependencies # set this to site/kcworks/dependencies under the base directory of your cloned repository
