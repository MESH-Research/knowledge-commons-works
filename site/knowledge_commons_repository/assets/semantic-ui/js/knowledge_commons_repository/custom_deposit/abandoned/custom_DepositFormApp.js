...
import { DepositBootstrap } from "./custom_DepositBootstrap";
import { DepositDraftsService, RDMDepositDraftsService } from "@js/invenio_rdm_records";
import { DepositFilesService, RDMDepositFilesService } from "@js/invenio_rdm_records";
import {
  DepositRecordSerializer,
  RDMDepositRecordSerializer,
} from "@js/invenio_rdm_records";
import { DepositService } from "@js/invenio_rdm_records";
import { configureStore } from "@js/invenio_rdm_records";
import { RDMUploadProgressNotifier } from "@js/invenio_rdm_records";
    ...
    return (
      <Provider store={this.store}>
        <I18nextProvider i18n={i18next}>
          <DepositBootstrap
            handleResourceTypeChange={this.props.handleResourceTypeChange}
          >
            {children}
          </DepositBootstrap>
        </I18nextProvider>
