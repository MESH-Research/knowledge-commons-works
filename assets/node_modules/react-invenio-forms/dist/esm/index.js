...
import { Ref, Image as Image$1, Grid, Sidebar, Segment, Button, Accordion, Container, Icon, Form, Label, Message } from 'semantic-ui-react';
import axios from 'axios';
import { FastField, Field, getIn, FieldArray, Formik, useFormikContext, useField } from 'formik';
  ...
  _createClass(Image, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Ref, {
        innerRef: this.myRef
      }, /*#__PURE__*/React.createElement(Image$1, Object.assign({
...
var GridResponsiveSidebarColumn = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(GridResponsiveSidebarColumn, [{
    key: "render",
    value: function render() {
      var closeSidebarBtnRef = /*#__PURE__*/React.createRef();
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grid.Column, {
        ...
        className: "mb-20"
      }), children)), /*#__PURE__*/React.createElement(Grid.Column, {
        width: width,
        only: "computer",
        computer: computer,
...
var AccordionField = /*#__PURE__*/function (_Component) {
  ...
  function AccordionField() {
    ...
    _this.renderAccordion = function (props) {
      ...
      var uiProps = _omit(_objectSpread2({}, ui), ["optimized", "includesPaths"]);
      ...
      var panels = [{
        ...
        content: {
          content: /*#__PURE__*/React.createElement(Container, null, children)
        }
      }];
      var errorClass = hasError ? "error secondary" : "";
      return /*#__PURE__*/React.createElement(Accordion, Object.assign({
  ...
  _createClass(AccordionField, [{
    ...
    value: function render() {
      ...
      var FormikField = optimized ? FastField : Field;
...
var ArrayField = /*#__PURE__*/function (_Component) {
  ...
  function ArrayField(_props) {
    ...
    _this.getValues = function (values, fieldPath) {
      ...
      var existingValues = getIn(values, fieldPath, []);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var valuesMatchingRequiredOption = _filter(existingValues, _matches(requiredOption));
    ...
    _this.renderFormField = function (props) {
      ...
      return /*#__PURE__*/React.createElement(Form.Field, Object.assign({}, uiProps, hasError), /*#__PURE__*/React.createElement(FieldLabel, {
        htmlFor: fieldPath,
        icon: labelIcon,
        label: label
        ...
        className: "helptext"
      }, helpText), /*#__PURE__*/React.createElement(Form.Group, null, /*#__PURE__*/React.createElement(Form.Button, {
        type: "button",
        icon: true,
  ...
  _createClass(BaseForm, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Formik, Object.assign({
        onSubmit: onSubmit
      }, formik), /*#__PURE__*/React.createElement(Form, null, children));
    }
  }]);
  return BaseForm;
}(Component);
...
var BooleanField = /*#__PURE__*/function (_Component) {
  ...
  function BooleanField() {
    ...
    _this.renderFormField = function (props) {
      ...
      var value = getIn(values, fieldPath, false);
      var initialValue = getIn(initialValues, fieldPath, false);
      ...
      return /*#__PURE__*/React.createElement(Form.Group, {
        ...
        htmlFor: fieldPath
      }, label), /*#__PURE__*/React.createElement(Form.Checkbox, Object.assign({
        id: fieldPath,
        name: fieldPath,
...
var ErrorLabel = /*#__PURE__*/function (_Component) {
  ...
  function ErrorLabel() {
    ...
    _this.renderFormField = function (_ref) {
      ...
      var error = _get(errors, fieldPath, "") || _get(initialErrors, fieldPath, "");
      return error ? /*#__PURE__*/React.createElement(Label, Object.assign({
        pointing: true,
        prompt: true,
        content: error
      }, uiProps)) : null;
...
var ErrorMessage = /*#__PURE__*/function (_Component) {
  ...
  function ErrorMessage() {
    ...
    _this.renderFormField = function (_ref) {
      ...
      return errors[fieldPath] ? /*#__PURE__*/React.createElement(Message, Object.assign({
        negative: true,
...
var GroupField = /*#__PURE__*/function (_React$Component) {
  ...
  function GroupField() {
    ...
    _this.renderFormField = function (props) {
      ...
      var errors = getIn(props, "form.errors");
  ...
  _createClass(GroupField, [{
    ...
    value: function render() {
      ...
      var FormikField = optimized ? FastField : Field;
      return /*#__PURE__*/React.createElement(FormikField, Object.assign({
        name: fieldPath,
        component: this.renderFormField,
        fieldPath: fieldPath,
  ...
  function SelectField() {
    ...
    _this.renderError = function (errors, name, value) {
      ...
      if (!Array.isArray(value)) {
        if (!_isEmpty(options) && !options.find(function (o) {
    ...
    _this.renderFormField = function (formikProps) {
      ...
      var value = getIn(values, fieldPath, defaultValue || _defaultValue);
      var initialValue = getIn(initialValues, fieldPath, _defaultValue);
      return /*#__PURE__*/React.createElement(Form.Dropdown, Object.assign({
        fluid: true,
...
var RemoteSelectField = /*#__PURE__*/function (_Component) {
  ...
  function RemoteSelectField(props) {
    ...
    _this.handleAddition = function (e, _ref2, callbackFunc) {
      ...
      _this.setState(function (prevState) {
        return {
          selectedSuggestions: newSelectedSuggestions,
          suggestions: _uniqBy([].concat(_toConsumableArray(prevState.suggestions), _toConsumableArray(newSelectedSuggestions)), "value")
        };
      }, function () {
        return callbackFunc(newSelectedSuggestions);
      });
    };
    _this.onSearchChange = _debounce( /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _this.setState(function (prevState) {
                  return {
                    suggestions: _uniqBy([].concat(_toConsumableArray(prevState.selectedSuggestions), _toConsumableArray(serializedSuggestions)), "value"),
                    isFetching: false,
                    error: false,
                    open: true
                  };
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", axios.get(suggestionAPIUrl, {
  ...
  _createClass(RemoteSelectField, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(SelectField, Object.assign({}, uiProps, {
...
var TextField = /*#__PURE__*/function (_Component) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var FormikField = optimized ? FastField : Field;
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormikField, {
        ...
        var field = _ref.field,
          meta = _ref.meta;
        return /*#__PURE__*/React.createElement(Form.Input, Object.assign({}, field, {
          error: meta.error,
          disabled: disabled,
          fluid: true,
          label: label,
...
var TextAreaField = /*#__PURE__*/function (_Component) {
  ...
  function TextAreaField() {
    ...
    _this.renderFormField = function (_ref) {
      ...
      }, /*#__PURE__*/React.createElement(Form.TextArea, Object.assign({
        id: fieldPath,
        name: fieldPath,
        onChange: form.handleChange,
        onBlur: form.handleBlur,
        value: getIn(form.values, fieldPath, "")
      }, uiProps)), /*#__PURE__*/React.createElement(ErrorLabel, {
        fieldPath: fieldPath
      }));
    };
    return _this;
...
var RadioField = /*#__PURE__*/function (_Component) {
  ...
  function RadioField() {
    ...
    _this.renderFormField = function (formikProps) {
      ...
      var uiProps = _omit(ui, ["optimized"]);
      return /*#__PURE__*/React.createElement(Form.Radio, Object.assign({
        name: fieldPath,
...
var RichInputField = /*#__PURE__*/function (_Component) {
  ...
  function RichInputField() {
    ...
    _this.renderFormField = function (formikBag) {
      ...
      var initialValue = getIn(formikBag.form.initialValues, fieldPath, "");
      var error = getIn(formikBag.form.errors, fieldPath, false) ||
      // We check if initialValue changed to display the initialError,
      // otherwise it would be displayed despite updating the field
      ...
      return /*#__PURE__*/React.createElement(Form.Field, {
        ...
        error: error,
        className: className
      }, /*#__PURE__*/React.isValidElement(label) ? label : /*#__PURE__*/React.createElement("label", {
        htmlFor: fieldPath
      }, label), /*#__PURE__*/React.createElement(CKEditor, {
...
var ToggleField = /*#__PURE__*/function (_Component) {
  ...
  function ToggleField() {
    ...
    _this.renderFormField = function (formikProps) {
      ...
      var isChecked = getIn(formikProps.form.values, fieldPath) === onValue;
      ...
      return /*#__PURE__*/React.createElement(RadioField, Object.assign({}, uiProps, {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 21:
            ...
            return _context.abrupt("return", /*#__PURE__*/React.createElement(component, _objectSpread2(_objectSpread2({}, props), {}, {
              key: fieldPath,
              fieldPath: fieldPath
            })));
          case 23:
...
var CustomFields = /*#__PURE__*/function (_Component) {
  ...
  _createClass(CustomFields, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, sections.map(function (_ref) {
...
var AutocompleteDropdown = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AutocompleteDropdown, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FieldLabel, {
        htmlFor: fieldPath,
        icon: icon,
        label: label
        ...
        return /*#__PURE__*/React.createElement(RemoteSelectField, {
          ...
          serializeSuggestions: function serializeSuggestions(suggestions) {
            return _isArray(suggestions) ? suggestions.map(function (item) {
              return {
          ...
          initialSuggestions: _get(values, "ui.".concat(fieldPath), [])
        });
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      var _this$props = this.props,
        ...
        clearable = _this$props.clearable,
        required = _this$props.required;
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SelectField, {
        fieldPath: fieldPath,
        label: /*#__PURE__*/React.createElement(FieldLabel, {
          htmlFor: fieldPath,
          icon: icon,
...
var TextArea = /*#__PURE__*/function (_Component) {
  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TextAreaField, {
        key: fieldPath,
        fieldPath: fieldPath,
        required: required,
        label: /*#__PURE__*/React.createElement(FieldLabel, {
...
function BooleanCheckbox(_ref) {
  var description = _ref.description,
    ...
    required = _ref.required;
  var _useField = useField(fieldPath),
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Form.Group, {
    ...
    value: false,
    optimized: true
  }), meta.error && /*#__PURE__*/React.createElement(Form.Field, {
    required: required,
    className: "error"
  }, /*#__PURE__*/React.createElement(Label, {
    pointing: "left",
    prompt: true
  }, meta.error))), description && /*#__PURE__*/React.createElement("label", {
    className: "helptext"
  }, description));
}
...
var http = axios.create(baseAxiosConfiguration);

export { AccordionField, Array$1 as Array, ArrayField, AutocompleteDropdown, BaseForm, BooleanCheckbox, BooleanField, CustomFields, Dropdown, ErrorLabel, ErrorMessage, FieldLabel, GridResponsiveSidebarColumn, GroupField, Image, Input, MultiInput, NumberInput, RadioField, RemoteSelectField, RichInput, RichInputField, SelectField, TextArea, TextAreaField, TextField, ToggleField, http, importWidget, loadWidgetsFromConfig, withCancel };
