...
import { Label, Icon, Input, Button, List, Checkbox, Card, Segment, Header, Menu, Pagination as Pagination$2, Image, Item, Loader, Dropdown } from 'semantic-ui-react';
...
var UrlParamValidator = /*#__PURE__*/_createClass(function UrlParamValidator() {
  ...
  this.isValid = function (urlHandler, key, value) {
    switch (key) {
      ...
      case "hiddenParams":
        {
          var array = _isArray(value) ? value : [value];
          var cKvSep = ":",
...
var updateQueryStateAfterResponse = function updateQueryStateAfterResponse(response, dispatch, getState, appConfig) {
  ...
  var updatedQueryState = _cloneDeep(getState().query);
  var urlHandlerApi = appConfig.urlHandlerApi;
  if (urlHandlerApi) {
...
var updateSearchSorting = function updateSearchSorting(queryState, appState, appConfig, dispatch) {
  ...
  var defaultSortingDefined = !_isEmpty(appConfig.defaultSortingOnEmptyQueryString);
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 10:
              ...
              if ("newQueryState" in response) {
                response = updateQueryStateAfterResponse(_cloneDeep(response), dispatch, getState, config);
              }
              dispatch({
...
function urlParamsChangedSorting(appConfig, initialQueryState, queryStateFromURLParams) {
  ...
  var isDefaultOnEmptyDefined = !_isEmpty(appConfig.defaultSortingOnEmptyQueryString);
...
var BootstrapComponent = Overridable.component("Bootstrap", Bootstrap$1);
...
var Bootstrap = connect(null, mapDispatchToProps$c)(BootstrapComponent);
  ...
  _createClass(ActiveFilters, [{
    ...
    value: function render() {
      var _this$props = this.props,
        ...
        overridableId = _this$props.overridableId;
      return !!filters.length && /*#__PURE__*/React.createElement(Element$g, {
        filters: filters,
...
var Element$g = function Element(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Overridable, {
    ...
    getLabel: getLabel
  }, /*#__PURE__*/React.createElement(React.Fragment, null, filters.map(function (filter, index) {
...
var ActiveFiltersComponent = Overridable.component("ActiveFilters", ActiveFilters$1);
...
var ActiveFilters = connect(function (state) {
  return {
  ...
  _createClass(AutocompleteSearchBar, [{
    ...
    value: function render() {
      var _this$props = this.props,
        ...
        overridableId = _this$props.overridableId;
      return /*#__PURE__*/React.createElement(Element$f, {
...
var AutocompleteSearchBarUncontrolled = function AutocompleteSearchBarUncontrolled(props) {
  return /*#__PURE__*/React.createElement(AutocompleteSearchBar$1, Object.assign({
...
var AutocompleteSearchBar = connect(mapStateToProps, mapDispatchToProps$a)(AutocompleteSearchBarComponent);
...
var BucketAggregation$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(BucketAggregation, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Element$e, Object.assign({
        title: this.title,
...
var Element$e = function Element(_ref3) {
  ...
  var _useContext = useContext(AppContext),
    buildUID = _useContext.buildUID;
  return containerCmp && /*#__PURE__*/React.createElement(Overridable, {
    id: buildUID("BucketAggregation.element", overridableId),
    agg: agg,
    title: title,
    containerCmp: containerCmp,
    updateQueryFilters: updateQueryFilters
  }, /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(Card.Content, null, /*#__PURE__*/React.createElement(Card.Header, null, title)), /*#__PURE__*/React.createElement(Card.Content, null, containerCmp)));
};
Element$e.defaultProps = {
  containerCmp: null,
  overridableId: ""
};
var BucketAggregationComponent = Overridable.component("BucketAggregation", BucketAggregation$1);
...
var BucketAggregation = connect(function (state) {
  return {
...
var Count$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Count, [{
    ...
    value: function render() {
      ...
      }, label( /*#__PURE__*/React.createElement(Element$d, {
...
var CountComponent = Overridable.component("Count", Count$1);
 ...
 * under the terms of the MIT License; see LICENSE file for more details.
 */
var Count = connect(function (state) {
  return {
...
var EmptyResults$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EmptyResults, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(Element$c, Object.assign({}, props, {
...
var EmptyResultsComponent = Overridable.component("EmptyResults", EmptyResults$1);
...
var EmptyResults = connect(function (state) {
  return {
    loading: state.results.loading,
    totalResults: state.results.data.total,
...
var Element$b = function Element(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Overridable, {
    ...
    error: error
  }, /*#__PURE__*/React.createElement("div", null, "Oops! Something went wrong while fetching results."));
};
Element$b.defaultProps = {
  overridableId: ""
};
var ErrorComponent = Overridable.component("Error", Error$2);
 ...
 * under the terms of the MIT License; see LICENSE file for more details.
 */
var Error$1 = connect(function (state) {
  return {
    loading: state.results.loading,
    error: state.results.error
  };
...
var LayoutSwitcherComponent = Overridable.component("LayoutSwitcher", LayoutSwitcher$1);
...
var LayoutSwitcher = connect(function (state) {
  return {
    loading: state.results.loading,
...
var Element$9 = function Element(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(Pagination$2, Object.assign({
...
var PaginationComponent = Overridable.component("Pagination", Pagination$1);
...
var Pagination = connect(function (state) {
  return {
...
var ResultsGridComponent = Overridable.component("ResultsGrid", ResultsGrid$1);
 ...
 * under the terms of the MIT License; see LICENSE file for more details.
 */
var ResultsGrid = connect(function (state) {
  return {
    loading: state.results.loading,
    totalResults: state.results.data.total,
...
function ResultsList$1(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ShouldRender$1, {
    condition: !loading && totalResults > 0
  }, /*#__PURE__*/React.createElement(Element$7, {
    results: results,
    overridableId: overridableId
  }));
}
...
var ResultsListComponent = Overridable.component("ResultsList", ResultsList$1);
 ...
 * under the terms of the MIT License; see LICENSE file for more details.
 */
var ResultsList = connect(function (state) {
  return {
    loading: state.results.loading,
    totalResults: state.results.data.total,
    results: state.results.data.hits
...
function ResultsLoader$1(_ref) {
  var children = _ref.children,
    ...
    overridableId = _ref.overridableId;
  return loading ? /*#__PURE__*/React.createElement(Element$6, {
    overridableId: overridableId
  }) : children;
}
...
var ResultsLoaderComponent = Overridable.component("ResultsLoader", ResultsLoader$1);
 ...
 * under the terms of the MIT License; see LICENSE file for more details.
 */
var ResultsLoader = connect(function (state) {
  return {
    loading: state.results.loading
  };
...
var Element$5 = function Element(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Overridable, {
    ...
    layout: layout
  }, layout === "list" ? /*#__PURE__*/React.createElement(ResultsList, {
    overridableId: overridableId
  }) : /*#__PURE__*/React.createElement(ResultsGrid, {
    overridableId: overridableId
  }));
};
...
var ResultsMultiLayoutComponent = Overridable.component("ResultsMultiLayout", ResultsMultiLayout$1);
 ...
 * under the terms of the MIT License; see LICENSE file for more details.
 */
var ResultsMultiLayout = connect(function (state) {
  return {
    loading: state.results.loading,
    totalResults: state.results.data.total,
    currentLayout: state.query.layout
...
var ResultsPerPage$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ResultsPerPage, [{
    ...
    value: function render() {
      ...
      }, label( /*#__PURE__*/React.createElement(Element$4, {
        currentSize: currentSize,
        options: this.options,
...
var ResultsPerPageComponent = Overridable.component("ResultsPerPage", ResultsPerPage$1);
...
var ResultsPerPage = connect(function (state) {
  return {
    loading: state.results.loading,
    currentSize: state.query.size,
    totalResults: state.results.data.total
...
var SearchBar$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SearchBar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Element$3, {
...
var SearchBarUncontrolled = function SearchBarUncontrolled(props) {
  ...
  return /*#__PURE__*/React.createElement(SearchBar$1, Object.assign({
    key: queryString
  }, props));
};
...
var SearchBar = connect(function (state) {
  return {
    queryString: state.query.queryString
  };
...
var Sort$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Sort, [{
    ...
    value: function render() {
      ...
      }, label( /*#__PURE__*/React.createElement(Element$2, {
...
var SortComponent = Overridable.component("Sort", Sort$1);
...
var Sort = connect(function (state) {
  return {
...
var SortBy$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SortBy, [{
    ...
    value: function render() {
      ...
      }, label( /*#__PURE__*/React.createElement(Element$1, {
        currentSortBy: currentSortBy,
        options: this.options,
        onValueChange: this.onChange,
        overridableId: overridableId,
...
var SortByComponent = Overridable.component("SortBy", SortBy$1);
...
var SortBy = connect(function (state) {
  return {
    loading: state.results.loading,
    totalResults: state.results.data.total,
    currentSortBy: state.query.sortBy
...
var SortOrder$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SortOrder, [{
    ...
    value: function render() {
      ...
      }, label( /*#__PURE__*/React.createElement(Element, {
        currentSortOrder: currentSortOrder,
        options: this.options,
        onValueChange: this.onChange,
        overridableId: overridableId,
...
var SortOrderComponent = Overridable.component("SortOrder", SortOrder$1);
...
var SortOrder = connect(function (state) {
  return {
    loading: state.results.loading,
    totalResults: state.results.data.total,
    currentSortOrder: state.query.sortOrder
...
var ToggleComponent = function ToggleComponent(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Overridable, {
    ...
    userSelectionFilters: userSelectionFilters,
    updateQueryFilters: updateQueryFilters
  }, /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(Card.Content, null, /*#__PURE__*/React.createElement(Card.Header, null, title)), /*#__PURE__*/React.createElement(Card.Content, null, /*#__PURE__*/React.createElement(Checkbox, {
    toggle: true,
    label: label,
    onClick: onClick,
    checked: isChecked
...
var ToggleComponent$1 = Overridable.component("SearchFilters.Toggle", ToggleComponent);
...
var Toggle = connect(function (state) {
  return {
    userSelectionFilters: state.query.filters
  };
...
export { ActiveFilters, AppContext, AutocompleteSearchBar, BucketAggregation, Count, ESRequestSerializer, ESResponseSerializer, ESSearchApi, EmptyResults, Error$1 as Error, InvenioRecordsResourcesRequestSerializer, InvenioRequestSerializer, InvenioResponseSerializer, InvenioSearchApi, InvenioSuggestionApi, LayoutSwitcher, Pagination, ReactSearchKit$1 as ReactSearchKit, RequestCancelledError, ResultsGrid, ResultsList, ResultsLoader, ResultsMultiLayout, ResultsPerPage, SearchBar, Sort, SortBy, SortOrder, Toggle, UrlHandlerApi, UrlParamValidator, buildUID, createStoreWithConfig, onQueryChanged, withState };
