...
const AdditionalDescriptionsField = ({fieldPath,
                                      options,
                                      recordUI={},
      ...
      if ( !!haveChangedNumber ) {
        if ( descriptionsLength < 0 ) {
          document.getElementById(`${fieldPath}.add-button`)?.focus();
            ...
            window.setTimeout(() => {
                document.querySelectorAll('.metadata-additional_descriptions-0-description .ck-editor__editable')[0].focus();
            }, 100);
        }
      }
    }, [descriptionsLength]);
        ...
        <>
          ...
          return (
            ...
            <Form.Group className="additional-description-item-row">
                <RichInputField
                mobile={16} tablet={14} computer={10}
                ...
                />
                <Form.Field
                    className="mobile hidden two wide"
                >
                    <Button
            ...
            <Form.Group>
                ...
                <LanguagesField
                    ...
                    selectOnBlur={false}
                />
                <Form.Field tablet={0} computer={0} mobile={2}
