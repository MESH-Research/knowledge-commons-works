 ...
 *
 * @param {string} addFormAction - Action to perform when closing the subform. Possible values are `saveAndContinue` and `saveAndClose`.
 */
...
//   );
//   const [action, setAction] = useState(addFormAction);
...
//   return (
//     <Form.Group className={`${fieldPath}-item-form`}>
//       {action === ModalActions.ADD ? (
