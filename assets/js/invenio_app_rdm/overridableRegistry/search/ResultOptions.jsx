...
const ResultOptions = ({
  ...
  const columnWidths = multipleLayouts ? columnWidthsMultipleLayouts : columnWidthsSingleLayout;
  ...
  return (
    (totalResults || null) && (
      ...
      >
        ...
        <Grid.Column {...columnWidths.sortOptions} className="">
          {sortOptions && (
        ...
        <Grid.Column
          ...
          textAlign="right"
          verticalAlign="middle"
          className="search-results-options-count pl-0"
        >
        ...
        <Grid.Column {...columnWidths.sidebarSpacer}></Grid.Column>
      </Grid.Row>
    )
  );
};
